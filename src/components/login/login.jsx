            ...
            <div className="login-page">
                ...
                <div className="container back-icon login-container">
                    <div className="frame-20">
                        <button className="return-button" onClick={this.onBack}>
                            <svg
                ...
                {/* ======= Start Text Section =======  */}
                <div className="container top-text login-container">
                    <p className="top-text-title">Welcome Back!</p>
                    <p className="top-text-text">
                        Log In to your Placoo account to explore your dream place to live across
                        the whole world!
                    </p>
                </div>
                {/* ======= End Text Section =======  */}
                {/* ======= Start Form Section =======  */}
                <div className="container form-container login-container">
                        ...
                        <div className="cta">
                            <div className="frame-32">
                                ...
                                <button className="hide-btn">
                                    <p className="hide-btn-text">log in</p>
                                </button>
                                <p className="reset-psw">Forgot password?</p>
                            </div>
                        </div>
                    </form>
                </div>
                {/* ======= End Form Section =======  */}
                <div className="container divider-or login-container">
                ...
                <div className="container social-cta login-container">
